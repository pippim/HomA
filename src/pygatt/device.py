""" pygatt / device.py (https://github.com/peplin/pygatt) - Modified by Pippim:
    2025-02-01 - Fix typos
"""
...
#print("\n device.py exceptions:", exceptions.__file__)
# device.py exceptions: /home/rick/HomA/pygatt/exceptions.pyc
...
class BLEDevice(object):
    ...
    def _notification_handles(self, uuid):
        ...
        # characteristic config handle - we can also do that with gatttool if we
    ...
    def subscribe(self, uuid, callback=None, indication=False,
        ...
        indication -- use indications (where each notification is ACKd). This is
    ...
    def resubscribe_all(self):
        """
        Re-enable all notifications and indications for uuids that were
